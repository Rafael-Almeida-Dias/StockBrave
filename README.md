...
O projeto StockBrave consiste no desenvolvimento de um banco de dados relacional voltado à análise de indicadores financeiros de empresas listadas em bolsa.
O objetivo é organizar setores, ativos e seus históricos trimestrais de indicadores, permitindo consultas estruturadas que auxiliem na interpretação dos dados.
